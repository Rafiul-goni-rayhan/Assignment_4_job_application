...
4-> Event Delegation involves attaching a single event listener to a parent element to manage events for all  future child elements, improving performance and memory.

5-> preventDefault() stops the browser's default action , while stopPropagation() prevents an event from bubbling up to parent elements.